	...
	public void handleMessage(String event){
		...
		try{
			...
			switch(eventcode){
				...
				case Constants.ARROW: keyBoardPress(KeyEvent.VK_CONTROL, KeyEvent.VK_A); break;
				case Constants.BRUSH: keyBoardPress(KeyEvent.VK_CONTROL, KeyEvent.VK_P); break;
				case Constants.ERASER: keyBoardPress(KeyEvent.VK_CONTROL, KeyEvent.VK_E); break;
				
				case Constants.BEFOREPAGE: keyBoardPress(KeyEvent.VK_P); break;
				case Constants.NEXTPAGE: keyBoardPress(KeyEvent.VK_N); break;
